...
@available(iOS 16.0, *)
fileprivate struct HStackEqualWidth_Layout: Layout
{
...
@available(macOS 13.0, *)
@available(iOS 16.0, *)
public struct HStackEqualWidth<C: View>: View
{
	...
	{
		HStackEqualWidth_Layout(spacing: self.spacing)
		{
			content()
		}
	}
